...
Page(Object.assign({}, Zan.Toast, {
  ...
  onShow: function () {
    ...
    //优惠券
    wx.request({
      url: 'https://shop.playonwechat.com/api/useable-coupon?sign=' + app.data.sign + '&operator_id=' + app.data.kid,
      data:{
...
//提交订单
  formSubmit: function (e) {
    ...
    if (dizhi.length == 0){
      ...
      wx.request({
        url: 'https://shop.playonwechat.com/api/create-order?sign=' + app.data.sign + '&type=' + that.data.type + '&rid=' + that.data.rid + '&operator_id=' + app.data.kid,
        data: {

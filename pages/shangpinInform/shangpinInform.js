...
Page(Object.assign({}, Zan.Toast, {
  ...
  onShow: function () {
    ...
    // 列表
    wx.request({
      url: "https://shop.playonwechat.com/api/order-detail?sign=" + app.data.sign + '&operator_id=' + app.data.kid,
      data: {
        oid: that.data.oid
      },
      header: {
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: 'https://shop.playonwechat.com/api/order-payment?sign=' + app.data.sign + '&operator_id=' + app.data.kid,
      data: {
        oid: that.data.oid
      },
      header: {

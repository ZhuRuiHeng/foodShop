...
Page(Object.assign({}, Zan.Toast, {
  ...
  tapKeyWorld1: function (e) {
    ...
    setTimeout(function () {                  // 获取模块列表索引
     ...
     // sonCategory = sonCategory;
      ...
      wx.request({
        url: "https://shop.playonwechat.com/api/goods-list?sign=" + app.data.sign + '&operator_id=' + app.data.kid,
        data: {
  ...
  onShow: function () {
    ...
    //获取所有分类
      wx.request({
        url: 'https://shop.playonwechat.com/api/get-category?sign=' + app.data.sign + '&operator_id=' + app.data.kid,
        method: "GET",
        success: function (res) {

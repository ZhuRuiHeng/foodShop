...
Page(Object.assign({}, Zan.Toast, {
  ...
  onShow: function (options) {
    ...
    console.log('sign:', app.data.sign, 'kid:',app.data.kid);
    wx.request({
      url: "https://shop.playonwechat.com/api/goods-detail?sign=" + app.data.sign + '&operator_id=' + app.data.kid,
      data: {
        gid: gid
      },
      header: {
...
//购买
  ...
  tianjia:function(){
    ...
    wx.request({
      url: "https://shop.playonwechat.com/api/collect-goods?sign=" + app.data.sign + '&operator_id=' + app.data.kid,
      data: {
        gid: that.data.gid
      },
      header: {
      ...
      success: function (res) {
        ...
        if (status == 1) {
          ...
          wx.request({
            url: "https://shop.playonwechat.com/api/remove-collection?sign=" + app.data.sign + '&operator_id=' + app.data.kid,
            data: {
              gid: that.data.gid
            },
            header: {
  ...
  //加入购物车
   addCars: function (e) {
    ...
    wx.request({
      url: "https://shop.playonwechat.com/api/add-carts?sign=" + app.data.sign + '&operator_id=' + app.data.kid,
      method: "POST",
      data: {
        gid: that.data.gid,
        num: that.data.price,

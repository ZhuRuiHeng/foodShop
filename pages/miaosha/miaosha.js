...
Page({
  ...
  onShow: function () {
    ...
    // 列表
    wx.request({
      url: 'https://shop.playonwechat.com/api/second-kill-list?sign=' + app.data.sign + '&operator_id=' + app.data.kid,
      header: {
    ...
    wx.request({
      url: 'https://shop.playonwechat.com/api/second-kill-times?sign=' + app.data.sign + '&operator_id=' + app.data.kid,
      header: {
        'content-type': 'application/json'
      },
      method: "GET",
